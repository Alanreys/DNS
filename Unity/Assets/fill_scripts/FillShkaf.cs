...
[ExecuteInEditMode]
public class FillShkaf : MonoBehaviour
{
    ...
    [Range(-0.09f, 0.15f)]
    public float depth_level0 = 0.035f;
    ...
    [Range(-0.09f, 0.15f)]
    public float depth_level1 = 0.035f;
    ...
    [Range(-0.09f, 0.15f)]
    public float depth_level2 = 0.035f;
    ...
    [Range(-0.09f, 0.15f)]
    public float depth_level3 = 0.035f;
    ...
    [Range(-0.09f, 0.15f)]
    public float depth_level4 = 0.035f;
    ...
    private void filling_level0()
    {
        ...
        for (int i = 0; i < level0_shelf.Length; i++)
        {
            if (level0_shelf[i] != null)
            {
                ...
                level0_shelf_obj[i].transform.localPosition = new Vector3(left_edge - center, depth_level0, -0.215f);
            }
            center += step;
        }
    }
    ...
    private void filling_level1()
    {
        ...
        for (int i = 0; i < level1_shelf.Length; i++)
        {
            if (level1_shelf[i] != null)
            {
                ...
                level1_shelf_obj[i].transform.localPosition = new Vector3(left_edge - center, depth_level1, -0.01f);
            }
            center += step;
        }
    }
    ...
    private void filling_level2()
    {
        ...
        for (int i = 0; i < level2_shelf.Length; i++)
        {
            if (level2_shelf[i] != null)
            {
                ...
                level2_shelf_obj[i].transform.localPosition = new Vector3(left_edge - center, depth_level2, 0.227f);
            }
            center += step;
        }
    }
    ...
    private void filling_level3()
    {
        ...
        for (int i = 0; i < level3_shelf.Length; i++)
        {
            if (level3_shelf[i] != null)
            {
                ...
                level3_shelf_obj[i].transform.localPosition = new Vector3(left_edge - center, depth_level3, 0.473f);
            }
            center += step;
        }
    }
    ...
    private void filling_level4()
    {
        ...
        for (int i = 0; i < level0_shelf.Length; i++)
        {
            if (level4_shelf[i] != null)
            {
                ...
                level4_shelf_obj[i].transform.localPosition = new Vector3(left_edge - center, depth_level4, 0.717f);
            }
            center += step;
        }
    }
