using UnityEngine;
[ExecuteInEditMode]
public class FillVodoleySmall2Sides : MonoBehaviour
{
    ...
    private void filling_level0()
    {
        ...
        for (int i = 0; i < level0_shelf.Length; i++)
        {
            if (level0_shelf[i] != null)
            {
                ...
                level0_shelf_obj[i].transform.localPosition = new Vector3(depth_level0, left_edge - center, (0.087f * depth_level0 - 0.0467f) / 0.293f);
            }
            center += step;
        }
    }
    private void filling_level1()
    {
        ...
        for (int i = 0; i < level1_shelf.Length; i++)
        {
            if (level1_shelf[i] != null)
            {
                ...
                level1_shelf_obj[i].transform.localPosition = new Vector3(depth_level1, left_edge - center, 0.035f);
            }
            center += step;
        }
    }
    private void filling_level2()
    {
        ...
        for (int i = 0; i < level2_shelf.Length; i++)
        {
            if (level2_shelf[i] != null)
            {
                ...
                level2_shelf_obj[i].transform.localPosition = new Vector3(depth_level2, left_edge - center, (0.0606f * depth_level2 + 0.0674f) / 0.2019f);
            }
            center += step;
        }
    }
    private void filling_level3()
    {
        ...
        for (int i = 0; i < level3_shelf.Length; i++)
        {
            if (level3_shelf[i] != null)
            {
                ...
                level3_shelf_obj[i].transform.localPosition = new Vector3(depth_level3, left_edge - center, 0.545f);
            }
            center += step;
        }
    }
    ...
    private void filling_level4()
    {
        ...
        for (int i = 0; i < level4_shelf.Length; i++)
        {
            if (level4_shelf[i] != null)
            {
                ...
                level4_shelf_obj[i].transform.localPosition = new Vector3(depth_level4, left_edge - center, -0.265f);
            }
            center += step;
        }
    }
    ...
    private void filling_level5()
    {
        ...
        for (int i = 0; i < level5_shelf.Length; i++)
        {
            if (level5_shelf[i] != null)
            {
                ...
                level5_shelf_obj[i].transform.localPosition = new Vector3(depth_level5, left_edge - center, -0.12f);
            }
            center += step;
        }
    }
    ...
    private void filling_level6()
    {
        ...
        for (int i = 0; i < level6_shelf.Length; i++)
        {
            if (level6_shelf[i] != null)
            {
                ...
                level6_shelf_obj[i].transform.localPosition = new Vector3(depth_level6, left_edge - center, 0.029f);
            }
            center += step;
        }
    }
    ...
    private void filling_level7()
    {
        ...
        for (int i = 0; i < level7_shelf.Length; i++)
        {
            if (level7_shelf[i] != null)
            {
                ...
                level7_shelf_obj[i].transform.localPosition = new Vector3(depth_level7, left_edge - center, 0.28f);
            }
            center += step;
        }
    }
